                        ...
                        <form method="POST" action="{{ route('password.store') }}" onsubmit="tampilLoadingAnimation(this)">
                            ...
                            <div class="form-group has-icon-left mb-3">
                                ...
                                <div class="position-relative">
                                    <input type="email" name="email" class="form-control form-control-lg rounded-3 fs-6" value="{{ old('email') ?? $request->email }}" required autofocus autocomplete="email" placeholder="Masukkan email">
                            ...
                            <div class="form-group has-icon-left mb-4">
                                ...
                                <div class="position-relative">
                                    <input type="password" name="password" class="form-control form-control-lg rounded-3 fs-6" required placeholder="Masukkan password">
                                    <div class="form-control-icon">
                            ...
                            <div class="form-group has-icon-left mb-4">
                                <label for="password-confirmation" class="form-label small text-secondary fw-semibold">Password Konfirmasi</label>
                                <div class="position-relative">
                                    <input type="password" name="password_confirmation" class="form-control form-control-lg rounded-3 fs-6" placeholder="Masukkan konfirmasi password">
                                    <div class="form-control-icon">
                                        <i class="bi bi-shield-lock"></i>
                                    </div>
                                </div>
