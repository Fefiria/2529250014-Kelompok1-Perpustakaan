            ...
            <div class="card-content">
                        ...
                        <div class="col-md-3 col-12">
                            ...
                            <div class="d-flex gap-2 w-100">
                                ...
                                @if(request('search') || request('status'))
                                    <a href="{{ route('admin.peminjaman.index') }}" class="btn btn-danger text-white w-50 d-flex align-items-center justify-content-center gap-2">
                ...
                @if($peminjamans->isEmpty())
                    <div class="text-center">
                        ...
                        <p class="mt-2 text-white">Peminjaman tidak ditemukan</p>
