            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form class="form" method="POST" action="{{ route('admin.user.store') }}" enctype="multipart/form-data" onsubmit="tampilLoadingAnimation()">
                            <div class="row gap-2">
                                {{-- Nama Input --}}
                                <div class="col-12">
                                ...
                                <div class="col-12 d-flex justify-content-end gap-3">
                                    ...
                                    <button id="tambahUser" type="submit" class="btn btn-primary fw-semibold">
                                        <span id="textTambah">
                                            <i class="bi bi-check-circle me-1"></i> Tambah Anggota
                                        </span>
...
@push('scripts')
    <script>
        function tampilLoadingAnimation(){
            const button = document.getElementById('tambahUser');
            const textTambah = document.getElementById('textTambah');
            const animasi = document.getElementById('spinner');
            const textLoading = document.getElementById('text-loading');
            
            button.disabled = true;
            textTambah.classList.add('d-none');
