                ...
                <div class="card-content">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.user.create') }}" class="btn btn-primary btn-sm">
                            <img src="{{ asset('assets/icons/adduser.png') }}" alt="Tambah Anggota" style="width: 20px; height: 20px; object-fit: contain;"> Tambah Anggota
                        </a>
                    </div>

                    <div class="card-body border-bottom border-secondary pb-3">
                        <form action="{{ route('admin.user.index') }}" method="GET" id="form-filter-user">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control border-secondary text-white search-input" id="search-user" name="search" value="{{ request('search') }}" placeholder="Ketik email/nama/username...">
                                    </div>
                                </div>

                                <div class="col-md-6 col-12">
                                    <label class="form-label text-white fw-bold small mb-1">Tampil anggota berdasarkan role</label>
                                    <select class="form-select p-2" name="role" id="filter-role" onchange="submitForm('false')">
                    ...
                    @if($users->isEmpty())
                        <div class="card-body text-center py-5">
                            ...
                            <p class="mt-2 text-white">Anggota tidak ditemukan</p>
                                            ...
                                            <td>
                                                <div class="d-inline-flex align-items-center gap-3">
                                                    ...
                                                    @elseif(auth()->user()->role == 'superadmin')
                                                        @if($user->role == 'admin')                                                            
                                                            <form method="POST" action="{{ route('admin.user.makeAdmin', $user->idUser) }}" class="m-0 p-0 d-inline-flex align-items-center" onsubmit="displayAlert(event, this, 'Apakah anda yakin ingin membuat user ini menjadi member?', 'warning')">
                                                                @csrf
...
@push('scripts') 
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            const form = document.getElementById('form-filter-user');
