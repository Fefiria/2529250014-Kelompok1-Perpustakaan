                ...
                <form class="form" method="POST" action="{{ route('admin.buku.store') }}" enctype="multipart/form-data" onsubmit="tampilLoadingAnimation(this)">
                    <div class="row gap-2">
                        ...
                        <div class="col-12 d-flex flex-wrap justify-content-end gap-2 mt-3">
                            <a href="{{ route('admin.buku.index') }}" class="btn btn-warning text-white fw-semibold px-3 py-2">
                                Kembali ke List
                            </a>

                            <button type="submit" class="btn btn-primary fw-semibold">
                                <span id="text-button">Tambah Buku</span>
                            ...
                            <button type="reset" class="btn btn-light-secondary px-3 py-2">
                                Reset
                            </button>
                        </div>
                    </div>
