                                ...
                                <div class="card-body">                                    
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <select id="jenisKelamin" name="jenisKelamin" class="form-select form-control-lg">
                                                    <option value="Laki-laki" {{ old('jenisKelamin', auth()->user()->jenisKelamin) == 'Laki-laki' ? 'selected' : '' }}>Laki-laki</option>
                                                    <option value="Perempuan" {{ old('jenisKelamin', auth()->user()->jenisKelamin) == 'Perempuan' ? 'selected' : '' }}>Perempuan</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex flex-wrap justify-content-end gap-2 mt-3">
                                        @if(auth()->user()->role == 'member')
                                            <a href="{{ route('member.dashboard') }}" class="btn btn-warning text-white px-3 py-2">
                                                </i> Kembali ke List
                                            </a>
                                        @else
                                            <a href="{{ route('admin.dashboard') }}" class="btn btn-warning text-white px-3 py-2">
                                                </i> Kembali ke List
                                            </a>
                                        @endif

                                        <button type="submit" class="btn btn-primary px-3 py-2">
                                            <span id="text-button">Simpan Perubahan</span>
