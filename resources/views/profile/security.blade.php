    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">Ubah pengaturan keamanan akun Anda di sini.</p>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('profile.security.updatePassword', auth()->user()->idUser) }}" method="POST">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group my-2 d-flex justify-content-end">
                            <form method="POST" action="{{ route('profile.security.deleteAccount', auth()->user()->idUser) }}" onsubmit="displayAlert(event, this, 'Akun', 'warning')">
                                @csrf
